...
export const ru: LangType = {
    ...
    'page.body.wallets.table.succeed': 'Успешно',
    'page.body.wallets.table.failed': 'Провалено',
    ...
    'page.body.wallets.beneficiaries.addAddressModal.body.testnetAddress': 'Testnet Address',
    ...
    'page.body.history.withdraw.header.fullName': 'Полное имя',
