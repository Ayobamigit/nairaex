...
import { CanCan, EstimatedValue, WalletsOverview, WalletsP2P, WalletsTransfer } from 'src/containers';
import { WalletsSpot } from 'src/custom/containers/Wallets/WalletsSpot';
